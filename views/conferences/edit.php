...
<head>
    ...
    <title>Edit Conference - Conference Scheduler</title>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <h2 class="text-4xl font-extrabold text-on-surface tracking-tight">Edit Conference</h2>
                        </div>
                        <p class="text-on-surface-variant max-w-xl leading-relaxed">Update conference details and settings.</p>
                    </div>
                    <div class="text-right">
                        <p class="text-xs text-on-surface-variant">Conference ID</p>
                        <p class="text-sm font-bold text-on-surface">#CONF-<?= date('Y', strtotime($conference['start_date'])) ?>-<?= str_pad($conference['id'], 3, '0', STR_PAD_LEFT) ?></p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-span-12 lg:col-span-8 space-y-8">
                        <div class="bg-surface-container-lowest p-8 rounded-xl shadow-[0px_12px_32px_rgba(42,52,57,0.04)]">
                            ...
                            <input
                                ...
                                id="title"
                                name="title"
                                value="<?= htmlspecialchars($conference['title']) ?>"
                        ...
                        <div class="bg-surface-container-lowest p-8 rounded-xl shadow-[0px_12px_32px_rgba(42,52,57,0.04)]">
                            ...
                            <textarea
                                ...
                                rows="6"><?= htmlspecialchars($conference['description'] ?? '') ?></textarea>
                        </div>
                    </div>
                        ...
                        <div class="bg-surface-container-low p-8 rounded-xl">
                            ...
                            <div class="relative">
                                <select
                                    ...
                                    name="status"
                                    required>
                                    <option value="upcoming" <?= $conference['status'] === 'upcoming' ? 'selected' : '' ?>>Upcoming</option>
                                    <option value="ongoing" <?= $conference['status'] === 'ongoing' ? 'selected' : '' ?>>Ongoing</option>
                                    <option value="finished" <?= $conference['status'] === 'finished' ? 'selected' : '' ?>>Finished</option>
                                </select>
                        ...
                        <div class="bg-surface-container-low p-8 rounded-xl">
                            ...
                            <div class="flex items-center bg-white rounded-lg px-4 focus-within:ring-2 focus-within:ring-primary/20">
                                ...
                                <input
                                    ...
                                    id="location"
                                    name="location"
                                    value="<?= htmlspecialchars($conference['location'] ?? '') ?>"
                        ...
                        <div class="bg-surface-container-lowest p-8 rounded-xl shadow-[0px_12px_32px_rgba(42,52,57,0.04)] space-y-6">
                            <div>
                                ...
                                <input
                                    ...
                                    id="start_date"
                                    name="start_date"
                                    value="<?= htmlspecialchars($conference['start_date']) ?>"
                                    type="date"
                                    required />
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    id="end_date"
                                    name="end_date"
                                    value="<?= htmlspecialchars($conference['end_date']) ?>"
                                    type="date"
                                    required />
                            </div>
                        </div>
            ...
            <div class="mt-16 p-6 bg-surface-container-low rounded-xl">
                <div class="grid grid-cols-2 gap-6 text-sm">
                    <div>
                        ...
                        <p class="text-on-surface font-medium"><?= date('M d, Y g:i A', strtotime($conference['created_at'])) ?></p>
                    </div>
                    <div>
                        <p class="text-xs text-on-surface-variant uppercase tracking-widest mb-1">Last Updated</p>
                        <p class="text-on-surface font-medium"><?= date('M d, Y g:i A', strtotime($conference['updated_at'])) ?></p>
                    </div>
                </div>
            </div>
        </div>
