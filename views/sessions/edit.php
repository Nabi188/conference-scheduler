...
<head>
    ...
    <title>Edit Session - Conference Scheduler</title>
    ...
    <main class="ml-64 p-12 min-h-screen">
        <div class="max-w-6xl mx-auto">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <h1 class="text-[3.5rem] font-extrabold tracking-tight text-on-surface font-headline leading-none">Edit Session</h1>
                        </div>
                        <p class="text-on-surface-variant font-body text-lg max-w-2xl">Update session details and scheduling information.</p>
                    </div>
                    <div class="text-right">
                        <p class="text-xs text-on-surface-variant">Session ID</p>
                        <p class="text-sm font-bold text-on-surface">#<?= str_pad($session['id'], 4, '0', STR_PAD_LEFT) ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-surface-container-lowest rounded-xl border border-surface-container-high shadow-sm">
                <div class="p-10">
                    <form method="POST" action="<?= route('session', 'update', $session['id']) ?>" class="space-y-10">
                        <!-- Session Title -->
                        <div class="space-y-2">
                            ...
                            <input
                                ...
                                name="title"
                                required
                                value="<?= htmlspecialchars($session['title']) ?>"
                                ...
                                <div class="relative">
                                    <select
                                        ...
                                        <?php foreach ($conferences as $conference): ?>
                                            <option value="<?= $conference['id'] ?>" <?= $session['conference_id'] == $conference['id'] ? 'selected' : '' ?>>
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea
                                ...
                                class="w-full bg-surface-container-low border-0 rounded-xl p-6 font-body leading-relaxed focus:ring-2 focus:ring-primary resize-none"><?= htmlspecialchars($session['description'] ?? '') ?></textarea>
                        </div>
