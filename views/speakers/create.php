...
<head>
    ...
    <title>Create Speaker - Conference Scheduler</title>
        ...
        <div class="p-12">
            <div class="mb-12">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <h1 class="text-4xl font-manrope font-extrabold text-on-surface tracking-tight">Create Speaker</h1>
                </div>
                ...
                <div class="col-span-12 lg:col-span-4">
                    <div class="bg-surface-container-lowest p-8 rounded-xl flex flex-col items-center text-center sticky top-24">
                        <div class="relative group mb-6">
                            <div class="w-48 h-48 rounded-full overflow-hidden p-1 border-2 border-primary/10 bg-surface-container flex items-center justify-center">
                                <span class="material-symbols-outlined text-6xl text-on-surface-variant">person</span>
                            </div>
                        </div>
                        <h3 class="text-lg font-bold font-manrope text-on-surface-variant">New Speaker</h3>
                        <p class="text-sm text-on-surface-variant mb-6">Profile Preview</p>
                    </div>
                </div>

                <!-- Right Column: Form -->
                <div class="col-span-12 lg:col-span-8">
                    <form method="POST" action="<?= route('speaker', 'store') ?>" class="space-y-8">
